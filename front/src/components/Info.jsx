  ...
  return (
    <div className="info">
      ...
      <div className="content">
        ...
        <p>
          After clicking the button, the software generates words in the <i>Generated words </i>
          section, making it easier for you to analyze and identify patterns to
          understand the language generated by your grammar. <br />
          In the section below <i>(Rules applied section)</i>, you will find the same words along with an
          explanation of the rules used to generate them. This breakdown helps
          in understanding how each word was formed, helping in comprehension of
